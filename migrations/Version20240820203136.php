 ...
 */
final class Version20240820203136 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'add employee table and project table';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT NOT NULL, users_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5D9F75A167B3B43D ON employee (users_id)');
        ...
        $this->addSql('ALTER TABLE employee ADD CONSTRAINT FK_5D9F75A167B3B43D FOREIGN KEY (users_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employee DROP CONSTRAINT FK_5D9F75A167B3B43D');
